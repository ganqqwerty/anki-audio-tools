...
def injection_script(
    ...
    *,
    ...
    pending_editor_intent: dict[str, object] | None = None,
    backend_editor_context: dict[str, object] | None = None,
    ...
    config = {
        ...
        "pendingEditorIntent": pending_editor_intent,
        "backendEditorContext": backend_editor_context,

...
from .editor_webview_injection import _initial_status_by_field, editor_injection_script
...
_show_learner_recording_file = editor_callbacks._show_learner_recording_file
_share_current_audio_file = editor_callbacks._share_current_audio_file
_share_learner_recording_file = editor_callbacks._share_learner_recording_file

...
_record_learner_voice = _with_deps(editor_recording.record_learner_voice, _recording_deps)
_play_learner_recording = _with_deps(editor_recording.play_learner_recording, _recording_deps)

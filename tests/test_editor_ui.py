...
def test_injection_script_embeds_audio_field_indices() -> None:
    ...
    assert '"aqe:mp-senet": "mp-senet"' in script
    ...
    assert 'makeButton("MP-SENet", "Denoise speech with MP-SENet", "aqe:mp-senet"' in script
    assert (
    ...
    assert 'if (command === "aqe:mp-senet") return "Denoising with MP-SENet...";' in script

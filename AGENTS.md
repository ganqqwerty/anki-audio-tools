...
| `tests/test_architecture/` | Architecture boundary enforcement, explained in @ARCHITECTURE.md            |
...
| E2E tests (preflights runtime, then builds frontend) | `python3 scripts/dev.py test-e2e` |

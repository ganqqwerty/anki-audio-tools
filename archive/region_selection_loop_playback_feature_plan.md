...
Editing commands include destructive-output operations that generate a new audio reference, such as Volume +, Volume -, Slower, Faster, Trim, Remove noise, Remove pauses, Sidon, and MP-SENet.

    ...
    <div class="aqe-help-body">
      <section class="aqe-help-section">
        ...
        <ul class="aqe-help-list">
          ...
          <li>{t("editor.help.delete_region")}</li>

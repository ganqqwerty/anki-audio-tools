...
<div class="preset-subsection">
  <FieldTooltipTarget block content={t("settings.presets.graph_enabled.tooltip")}>
  ...
  {#if graph.enabled}
    <div class="settings-grid">
      <FieldTooltipTarget block content={t("graph.voice_range.note")}>
      ...
      <FieldTooltipTarget block content={t("graph.recording_condition.note")}>
        <label class="settings-field">
      ...
      <FieldTooltipTarget block content={t("settings.graph_smoothness.tooltip")}>
        <label class="settings-field">
      ...
      <FieldTooltipTarget block content={t("graph.connect_dropouts.note")}>
        <label class="settings-field">
      ...
      <FieldTooltipTarget block content={t("graph.voice_lock.note")}>
        <label class="settings-field">

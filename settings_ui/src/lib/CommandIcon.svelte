...
<span class={className} aria-hidden="true">
  ...
  {:else if icon === "redo-2"}
    <Redo2 {size} {strokeWidth} />
  {:else if icon === "refresh-cw"}
    <RefreshCw {size} {strokeWidth} />
  ...
  {:else if icon === "trash-2"}
    <Trash2 {size} {strokeWidth} />
  {:else if icon === "undo-2"}
    <Undo2 {size} {strokeWidth} />
